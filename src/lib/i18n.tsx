...
const AR: Record<string, string> = {
  ...
  "No editions found in": "لا توجد طبعات في",
  "Try refining the query.": "حاول تحسين الاستعلام.",

  // Archive page
  "Volumes finished": "مجلّدات أُنهيت",
  "No volumes closed this year.": "لم تُغلق مجلّدات هذا العام.",
  "Hours (est.)": "ساعات (تقديرًا)",
  "Dominant arc": "القوس الغالب",
  "Highest rated": "الأعلى تقييمًا",
  "Most-quoted author": "الأكثر اقتباسًا",
  "The line that hit hardest": "السطر الذي أوجع أكثر",
  "Your reading identity, this year": "هويّتك القرائية هذا العام",

  // Ritual extras
  "Coach": "مدرّب",
  "Tell me how you feel and how long you have.": "أخبرني بشعورك وكم لديك من الوقت.",
  "Pick for me": "اختر لي",
  "Volume": "المجلّد",
  "Tonight:": "الليلة:",
  "READING": "أقرأ",
  ...
  "Page from": "من صفحة",
  "Page to": "إلى صفحة",
  "Session intention": "نيّة الجلسة",
  "Mid-session capture": "التقاط أثناء الجلسة",
  "A line you must keep…": "سطر يجب أن تحتفظ به…",
  "Quote saved": "تم حفظ الاقتباس",
  "Mood pulse": "نبض المزاج",
  "Closing thought (becomes a journal entry)": "فكرة ختامية (تصبح مُدوّنة)",
  "What surprised you? What are you thinking about? Energy 1–5?": "ما الذي فاجأك؟ بمَ تفكّر؟ طاقتك 1–5؟",
  "Coach reflection": "تأمّل المدرّب",
  "Save to journal": "احفظ في المُدوّنة",
  "Saved to journal": "تم الحفظ في المُدوّنة",
  "Reading your session…": "أقرأ جلستك…",
  "Begin a new session": "ابدأ جلسة جديدة",
  "Last 12 weeks": "آخر 12 أسبوعًا",
  "Minutes this week": "دقائق هذا الأسبوع",
  "Sessions all-time": "إجمالي الجلسات",
  "Average session": "متوسط الجلسة",
  "Active streak": "تتابع نشط",
  "No book is currently being read. Set one to \"Reading\" first.": "لا يوجد كتاب قيد القراءة حاليًا. اضبط أحدها على «أقرأ» أولًا.",
  "Session logged": "تم تسجيل الجلسة",
  "Session too short to log.": "الجلسة قصيرة جدًا لتسجيلها.",
  "No books are marked Reading.": "لا توجد كتب مُعلَّمة بأنها قيد القراءة.",
  "Tonight": "الليلة",
  "Couldn't parse the pick.": "تعذّر فهم الاختيار.",
  "Pick made, but couldn't match it to your shelf.": "تم الاختيار، لكن لم نجده في رفّك.",
  ...
  // BookBrain (dossier page)
  "Composing…": "جارٍ التأليف…",
  "Remove this volume?": "إزالة هذا المجلّد؟",
  "This deletes the book and its notes from this shelf. This cannot be undone.": "سيُحذف الكتاب وملاحظاته من هذا الرف. لا يمكن التراجع.",
  "Delete book": "احذف الكتاب",
  "Book deleted": "تم حذف الكتاب",
  "This book has slipped from the shelf.": "هذا الكتاب انزلق عن الرف.",
  "Dossier": "الملفّ",
  "Prefills language, ISBN, cover, page count, and seeds a first-underlined prompt. Optionally draws connections to other books from the same saved search.": "يملأ مسبقًا اللغة وISBN والغلاف وعدد الصفحات ويزرع جملة أوّل ما خطّيت، ويربط اختياريًا بكتب من نفس البحث المحفوظ.",
  "Apply + suggest connections": "طبّق + اقترح روابط",
  "Apply edition only": "طبّق الطبعة فقط",
  "Dismiss": "تجاهَل",
  "Generate AI cover": "أنشئ غلافًا بالذكاء",
  "Regenerate AI cover": "أعد إنشاء الغلاف بالذكاء",
  "Status updated": "تم تحديث الحالة",
  "Spine artwork": "فنّ الكعب",
  "No custom spine yet. Generate one to see this book's unique spine on the shelf.": "لا يوجد كعب مخصّص بعد. أنشئ واحدًا لتراه فريدًا على الرف.",
  "Spine artwork generated": "تم إنشاء فنّ الكعب",
  "Sessions": "الجلسات",
  "No sessions logged yet.": "لم تُسجَّل جلسات بعد.",
  "Journal": "المُدوّنة",
  "Emotional Arc": "القوس العاطفي",
  "Connections": "الروابط",
  "AI Dissection": "تشريح بالذكاء",
  "What did the page do to you today?": "ماذا فعلَت بكَ الصفحة اليوم؟",
  "Inscribe": "اكتب",
  "Entry saved": "تم حفظ المُدخل",
  "No marginalia yet.": "لا حواشي بعد.",
  "No events yet. Start a ritual or save a quote.": "لا أحداث بعد. ابدأ طقسًا أو احفظ اقتباسًا.",
  "Reading session": "جلسة قراءة",
  "Journal entry": "مُدخل مُدوّنة",
  "Quote saved (timeline)": "اقتباس محفوظ",
  "Paste the quote…": "ألصق الاقتباس…",
  "Page": "الصفحة",
  "A personal note (optional)…": "ملاحظة شخصية (اختياري)…",
  "Save Quote": "احفظ الاقتباس",
  "Quote oracle": "عرّاف الاقتباسات",
  "Pull the most-cited verbatim lines from": "استخرج أكثر الأسطر اقتباسًا من",
  "Summoning": "أستحضر",
  "Find quotes": "ابحث عن اقتباسات",
  "Refresh": "حدّث",
  "Saved to your vault": "تم الحفظ في خزانتك",
  "No quotes returned — try again.": "لم تُرجَع اقتباسات — حاول مرة أخرى.",
  "AI unavailable": "الذكاء غير متاح",
  "The vault is empty.": "الخزانة فارغة.",
  "Linked volumes": "مجلّدات مرتبطة",
  "Add a connection": "أضف رابطًا",
  "Thematically similar": "متشابه موضوعيًا",
  "Contradicts": "يناقض",
  "Continues": "يواصل",
  "Influenced by": "متأثر بـ",
  "Made me think of": "ذكّرني بـ",
  "Draw connection": "ارسم الرابط",
  "Connection drawn": "تم رسم الرابط",
  "A reflection of your particular reading — built from your notes, quotes, and emotional arc. Not Wikipedia.": "تأمّل في قراءتك الخاصة — مبني على ملاحظاتك واقتباساتك وقوسك العاطفي. ليست ويكيبيديا.",
  "Generate dissection": "أنشئ التشريح",
  "none": "لا شيء",
  "add tag, press enter": "أضف وسمًا واضغط إدخال",
  "How I found it": "كيف وجدته",
  "Lost to memory.": "ضاع في الذاكرة.",
  "Adjacent in my library": "مجاور في مكتبتي",
  "Nothing yet.": "لا شيء بعد.",
  "Saved searches for this book": "بحثات محفوظة لهذا الكتاب",
  "editions": "طبعات",
  "First sentence I underlined": "أول جملة خطّطت تحتها",
  "pp": "ص",
  "spine": "كعب",
  "Source": "المصدر",
  "Book details refreshed": "تم تحديث تفاصيل الكتاب",
  "Metadata refresh failed": "فشل تحديث البيانات",
  "Spine generation failed": "فشل إنشاء الكعب",
  "Spine generation returned no image": "لم يُرجِع إنشاء الكعب صورة",
  ...
  "Editions across the": "طبعات عبر",
  "tongues of the world": "ألسنة العالم",
  "Type a book, however roughly. We identify it, then surface the best editions in English, Arabic, French, and German — with ISBN and publisher — plus AI-powered companion tools.": "اكتب اسم كتاب ولو تقريبيًا. نتعرّف عليه ثم نعرض أفضل الطبعات بالإنجليزية والعربية والفرنسية والألمانية — مع ISBN والناشر — وأدوات مرافقة بالذكاء الاصطناعي.",
  "e.g. crime and punishment, the prophet kahlil, sapiens harari…": "مثلاً: الجريمة والعقاب، النبي جبران، ساپينس هراري…",
  "Find editions": "ابحث عن الطبعات",
  "Saved recommendations": "التوصيات المحفوظة",
  "Saved to your recommendations": "حُفظ في توصياتك",
  "Search saved so we can re-apply it later": "حُفظ البحث لنطبّقه لاحقًا",
  ...
  "Save search": "احفظ البحث",
  "Best edition per language": "أفضل طبعة لكل لغة",
  "No editions surfaced. Try a more specific title.": "لا توجد طبعات. جرّب عنوانًا أدق.",
  "Publisher": "الناشر",
  "Pages": "الصفحات",
  "Copy": "انسخ",
  "Preview": "معاينة",
  ...
  "Apply edition": "طبّق الطبعة",
  "Close": "أغلق",
  "Choose which Book Brain entry should receive this edition's language, ISBN, cover, and a first-underlined prompt.": "اختر سجل كتاب يتلقى لغة هذه الطبعة و ISBN والغلاف وأول سطر تخطّه.",
  "Your shelf is empty. Add a book first, then return here to apply the edition.": "رفّك فارغ. أضف كتابًا أولًا ثم عُد لتطبّق الطبعة.",

  // History page extras
  "The Memory Vault": "خزانة الذاكرة",
  "Every dossier you've composed, kept forever. Open a book on your shelf and tap Generate to add it here.": "كل ملف ركّبته يبقى للأبد. افتح كتابًا في رفك ثم اضغط «أنشئ» ليُضاف هنا.",
